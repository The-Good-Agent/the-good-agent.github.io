...
function togglePopup() {
    ...
    var overlay = document.querySelector(".pop-up-form-container");
    overlay.classList.toggle("show");
}

// Checks whether all required input fields in the form are filled. //
// If they are, it enables the submit button; otherwise, it keeps it disabled //
